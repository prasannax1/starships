...
module class_5_secondary() {
    ...
    util_mirrored([0,0,1])
    util_mirrored([0,1,0])
    translate([-disk_1_width,disk_1_width/4,-disk_1_width/4])
    rotate([90,0,0])
    class_5_nacelle();
    
    translate([-class_5_nacelle_hangar_l/2,0,disk_1_width/2-.01])
    class_5_hangar();
}
...
module class_5_nacelle() {
    scale([class_5_nacelle_l/(disk_1_width*.57), 1, 1]) {
